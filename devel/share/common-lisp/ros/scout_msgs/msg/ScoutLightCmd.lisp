...
(cl:defclass <ScoutLightCmd> (roslisp-msg-protocol:ros-message)
  ((cmd_ctrl_allowed
    :reader cmd_ctrl_allowed
    :initarg :cmd_ctrl_allowed
    :type cl:boolean
    :initform cl:nil)
   (front_mode
    :reader front_mode
...
(cl:ensure-generic-function 'cmd_ctrl_allowed-val :lambda-list '(m))
(cl:defmethod cmd_ctrl_allowed-val ((m <ScoutLightCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_msgs-msg:cmd_ctrl_allowed-val is deprecated.  Use scout_msgs-msg:cmd_ctrl_allowed instead.")
  (cmd_ctrl_allowed m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ScoutLightCmd>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'cmd_ctrl_allowed) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ScoutLightCmd>) istream)
  "Deserializes a message object of type '<ScoutLightCmd>"
    (cl:setf (cl:slot-value msg 'cmd_ctrl_allowed) (cl:not (cl:zerop (cl:read-byte istream))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ScoutLightCmd>)))
  ...
  "42aa2cbe1b10fa7205fd418eae255dfd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ScoutLightCmd)))
  "Returns md5sum for a message object of type 'ScoutLightCmd"
  "42aa2cbe1b10fa7205fd418eae255dfd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ScoutLightCmd>)))
  ...
  (cl:format cl:nil "uint8 LIGHT_CONST_OFF = 0~%uint8 LIGHT_CONST_ON = 1~%uint8 LIGHT_BREATH = 2~%uint8 LIGHT_CUSTOM = 3~%~%bool cmd_ctrl_allowed~%uint8 front_mode~%uint8 front_custom_value~%uint8 rear_mode~%uint8 rear_custom_value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ScoutLightCmd)))
  "Returns full string definition for message of type 'ScoutLightCmd"
  (cl:format cl:nil "uint8 LIGHT_CONST_OFF = 0~%uint8 LIGHT_CONST_ON = 1~%uint8 LIGHT_BREATH = 2~%uint8 LIGHT_CUSTOM = 3~%~%bool cmd_ctrl_allowed~%uint8 front_mode~%uint8 front_custom_value~%uint8 rear_mode~%uint8 rear_custom_value~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ScoutLightCmd>))
  ...
  (cl:list 'ScoutLightCmd
    (cl:cons ':cmd_ctrl_allowed (cmd_ctrl_allowed msg))
